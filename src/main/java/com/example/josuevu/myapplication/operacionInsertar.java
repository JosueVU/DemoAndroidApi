...
public class operacionInsertar extends Fragment {
    View myView;
    private static int RESULT_LOAD_IMAGE = 1;
    GridView gridView;
    //String jsonURL="http://jsonplaceholder.typicode.com/users";
    String jsonURL="http://172.16.31.42/INEC.TEMA1.WebAPI/api/Usuario/AgregarUsuario";
    GridView gv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.opcion_insertar, container, false);
